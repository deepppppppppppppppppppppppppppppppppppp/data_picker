...
var G_datepicker = {
    ...
    blind: function() {
        ...
        __this.cal.on("timechangetonow", function(e) {
            ...
            __this.date_pick = dateNow.year + "-" + dateNow.month;
            __this.time_pick = hour_time + ":" + minute_time + ":" + second_time;
            __this.dateOut();
        });
...
$(document).on("click",function(e){
    ...
    // console.log($(document).find(".cal-container").length);
    console.log((target.is("input") && target.hasClass("g-date-picker")));
    console.log(target.hasClass("cal-container"));
    console.log(target.parents(".cal-container").length>0);
    // console.log();
    // console.log();
